## ECE 372 - Dynamic Programming and Optimal Control, Fall 2025/2026
...
- Make sure the environment is set up properly. Launch Python and try the following block. It should run without errors.
